...
export async function seedDatabase() {
  ...
  if (existingCategories.length === 0) {
    await db.insert(categories).values([
      { id: crypto.randomUUID(), name: "Dinners", slug: "dinners", description: "Hearty evening meals" },
      { id: crypto.randomUUID(), name: "Healthy", slug: "healthy", description: "Nutritious and delicious" },
      { id: crypto.randomUUID(), name: "Quick & Easy", slug: "quick-easy", description: "Under 30 minutes" },
      { id: crypto.randomUUID(), name: "Desserts", slug: "desserts", description: "Sweet treats" },
      { id: crypto.randomUUID(), name: "Breakfast", slug: "breakfast", description: "Start your day right" },
    ]);
